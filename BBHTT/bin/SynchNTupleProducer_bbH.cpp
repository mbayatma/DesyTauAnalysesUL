//#include "SynchNTuples_bbH_em_definitions.h"
#include "DesyTauAnalyses/BBHTT/interface/SynchNTupleProducer_all_Defs_Alexeis.h"
//#include "NtupleMaker_bbH_TauID_em_functions.h"
...
void FillElMu(const AC1B *analysisTree, SynchTree *otree, int electronIndex, float dRIsoElectron, int muonIndex, float dRIsoMuon, int era, bool isEmbedded, bool isMcCorrectPuppi){
  ...
  //cout << "CALCULATED d0,dZ:  " << analysisTree->electron_dxy[electronIndex] << "   " << analysisTree->electron_dz[electronIndex] << "   " << 
//analysisTree->muon_dxy[muonIndex] << "   " <<  analysisTree->muon_dz[muonIndex] << endl;
