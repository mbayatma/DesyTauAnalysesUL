...
if (argc!=4) {
  ...
  if (era!="2018"&&era!="2017"&&era!="2016_pre"&&era!="2016_post") {
  ...
  TString friend_dir;
  bool IsEra2016 = 0;
  bool IsEra2016_pre = 0;
  bool IsEra2016_post = 0;
  bool IsEra2017 = 0;
  bool IsEra2018 = 0;
...
// Mapping of subsamples to output root-file
  ...
  input_dir ="/nfs/dust/cms/user/rasp/tautau_UL/" + era ;
  ...
  double xsecDYNLOIncl  = 0;
  double xsecDYNLO0Jets = 0;
  double xsecDYNLO1Jets = 0;
  double xsecDYNLO2Jets = 0;
