...
//  Float_t	 correction_againstElectronVTightMVA6_2;
  ...
  //acoplanarity angle defined between 0 and pi
  ...
  //vertex of the tau decay products
...
//gen vertex info is practical to have
  ...
  SynchTree(TTree *tree=0, TString ch = "mt", bool isGGH = false);
  virtual ~SynchTree();
