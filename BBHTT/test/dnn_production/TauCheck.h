...
// Fri May  5 22:23:01 2023 by ROOT version 6.14/09
// from TTree TauCheck/TauCheck
// found on file: /nfs/dust/cms/user/rasp/Run/tautau_dnn_sysJES_5Cat/2018/tt-NOMINAL_ntuple_Tau_2018.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         ff_total;
   Float_t         ff_qcd_stat_pt_unc1;
   Float_t         ff_qcd_stat_pt_unc2;
   Float_t         ff_qcd_stat_dR_unc1;
   Float_t         ff_qcd_stat_dR_unc2;
   Float_t         ff_qcd_syst;
   Float_t         ff_qcd_syst_dr_closure;
   Float_t         ff_qcd_syst_pt_2_closure;
   Float_t         ff_qcd_syst_met_closure;
   Float_t         ff_syst_alt_func;
   Float_t         qcd_syst_met_njet0_closure;
   Float_t         qcd_syst_met_njet1_closure;
   Float_t         qcd_syst_met_njet2_closure;
   Float_t         qcd_syst_DR_nbtag1;
   Float_t         qcd_syst_DR_nbtag2;
   Float_t         ff_qcd_stat_njet0_dm0;
   Float_t         ff_qcd_stat_njet0_dm1;
   Float_t         ff_qcd_stat_njet0_dm10;
   Float_t         ff_qcd_stat_njet0_dm11;
   Float_t         ff_qcd_stat_njet1_dm0;
   Float_t         ff_qcd_stat_njet1_dm1;
   Float_t         ff_qcd_stat_njet1_dm10;
   Float_t         ff_qcd_stat_njet1_dm11;
   Float_t         ff_qcd_stat_njet2_dm0;
   Float_t         ff_qcd_stat_njet2_dm1;
   Float_t         ff_qcd_stat_njet2_dm10;
   Float_t         ff_qcd_stat_njet2_dm11;
   Int_t           pred_class;
   Float_t         pred_class_proba;
   Float_t         pred_class_0_proba;
   Float_t         pred_class_1_proba;
   Float_t         pred_class_2_proba;
   Float_t         pred_class_3_proba;
   Float_t         pred_class_4_proba;
   ...
   TBranch        *b_ff_total;   //!
   TBranch        *b_ff_qcd_stat_pt_unc1;   //!
   TBranch        *b_ff_qcd_stat_pt_unc2;   //!
   TBranch        *b_ff_qcd_stat_dR_unc1;   //!
   TBranch        *b_ff_qcd_stat_dR_unc2;   //!
   TBranch        *b_ff_qcd_syst;   //!
   TBranch        *b_ff_qcd_syst_dr_closure;   //!
   TBranch        *b_ff_qcd_syst_pt_2_closure;   //!
   TBranch        *b_ff_qcd_syst_met_closure;   //!
   TBranch        *b_ff_syst_alt_func;   //!
   TBranch        *b_qcd_syst_met_njet0_closure;   //!
   TBranch        *b_qcd_syst_met_njet1_closure;   //!
   TBranch        *b_qcd_syst_met_njet2_closure;   //!
   TBranch        *b_qcd_syst_DR_nbtag1;   //!
   TBranch        *b_qcd_syst_DR_nbtag2;   //!
   TBranch        *b_ff_qcd_stat_njet0_dm0;   //!
   TBranch        *b_ff_qcd_stat_njet0_dm1;   //!
   TBranch        *b_ff_qcd_stat_njet0_dm10;   //!
   TBranch        *b_ff_qcd_stat_njet0_dm11;   //!
   TBranch        *b_ff_qcd_stat_njet1_dm0;   //!
   TBranch        *b_ff_qcd_stat_njet1_dm1;   //!
   TBranch        *b_ff_qcd_stat_njet1_dm10;   //!
   TBranch        *b_ff_qcd_stat_njet1_dm11;   //!
   TBranch        *b_ff_qcd_stat_njet2_dm0;   //!
   TBranch        *b_ff_qcd_stat_njet2_dm1;   //!
   TBranch        *b_ff_qcd_stat_njet2_dm10;   //!
   TBranch        *b_ff_qcd_stat_njet2_dm11;   //!
   TBranch        *b_pred_class;   //!
   TBranch        *b_pred_class_proba;   //!
   TBranch        *b_pred_class_0_proba;   //!
   TBranch        *b_pred_class_1_proba;   //!
   TBranch        *b_pred_class_2_proba;   //!
   TBranch        *b_pred_class_3_proba;   //!
   TBranch        *b_pred_class_4_proba;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/nfs/dust/cms/user/rasp/Run/tautau_dnn_sysJES_5Cat/2018/tt-NOMINAL_ntuple_Tau_2018.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/nfs/dust/cms/user/rasp/Run/tautau_dnn_sysJES_5Cat/2018/tt-NOMINAL_ntuple_Tau_2018.root");
      }
...
void TauCheck::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("ff_total", &ff_total, &b_ff_total);
   fChain->SetBranchAddress("ff_qcd_stat_pt_unc1", &ff_qcd_stat_pt_unc1, &b_ff_qcd_stat_pt_unc1);
   fChain->SetBranchAddress("ff_qcd_stat_pt_unc2", &ff_qcd_stat_pt_unc2, &b_ff_qcd_stat_pt_unc2);
   fChain->SetBranchAddress("ff_qcd_stat_dR_unc1", &ff_qcd_stat_dR_unc1, &b_ff_qcd_stat_dR_unc1);
   fChain->SetBranchAddress("ff_qcd_stat_dR_unc2", &ff_qcd_stat_dR_unc2, &b_ff_qcd_stat_dR_unc2);
//    fChain->SetBranchAddress("ff_qcd_syst", &ff_qcd_syst, &b_ff_qcd_syst);
   fChain->SetBranchAddress("ff_qcd_syst_dr_closure", &ff_qcd_syst_dr_closure, &b_ff_qcd_syst_dr_closure);
   fChain->SetBranchAddress("ff_qcd_syst_pt_2_closure", &ff_qcd_syst_pt_2_closure, &b_ff_qcd_syst_pt_2_closure);
   fChain->SetBranchAddress("ff_qcd_syst_met_closure", &ff_qcd_syst_met_closure, &b_ff_qcd_syst_met_closure);
   fChain->SetBranchAddress("ff_syst_alt_func", &ff_syst_alt_func, &b_ff_syst_alt_func);
   fChain->SetBranchAddress("qcd_syst_met_njet0_closure", &qcd_syst_met_njet0_closure, &b_qcd_syst_met_njet0_closure);
   fChain->SetBranchAddress("qcd_syst_met_njet1_closure", &qcd_syst_met_njet1_closure, &b_qcd_syst_met_njet1_closure);
   fChain->SetBranchAddress("qcd_syst_met_njet2_closure", &qcd_syst_met_njet2_closure, &b_qcd_syst_met_njet2_closure);
   fChain->SetBranchAddress("qcd_syst_DR_nbtag1", &qcd_syst_DR_nbtag1, &b_qcd_syst_DR_nbtag1);
   fChain->SetBranchAddress("qcd_syst_DR_nbtag2", &qcd_syst_DR_nbtag2, &b_qcd_syst_DR_nbtag2);
   fChain->SetBranchAddress("ff_qcd_stat_njet0_dm0", &ff_qcd_stat_njet0_dm0, &b_ff_qcd_stat_njet0_dm0);
   fChain->SetBranchAddress("ff_qcd_stat_njet0_dm1", &ff_qcd_stat_njet0_dm1, &b_ff_qcd_stat_njet0_dm1);
   fChain->SetBranchAddress("ff_qcd_stat_njet0_dm10", &ff_qcd_stat_njet0_dm10, &b_ff_qcd_stat_njet0_dm10);
   fChain->SetBranchAddress("ff_qcd_stat_njet0_dm11", &ff_qcd_stat_njet0_dm11, &b_ff_qcd_stat_njet0_dm11);
   fChain->SetBranchAddress("ff_qcd_stat_njet1_dm0", &ff_qcd_stat_njet1_dm0, &b_ff_qcd_stat_njet1_dm0);
   fChain->SetBranchAddress("ff_qcd_stat_njet1_dm1", &ff_qcd_stat_njet1_dm1, &b_ff_qcd_stat_njet1_dm1);
   fChain->SetBranchAddress("ff_qcd_stat_njet1_dm10", &ff_qcd_stat_njet1_dm10, &b_ff_qcd_stat_njet1_dm10);
   fChain->SetBranchAddress("ff_qcd_stat_njet1_dm11", &ff_qcd_stat_njet1_dm11, &b_ff_qcd_stat_njet1_dm11);
   fChain->SetBranchAddress("ff_qcd_stat_njet2_dm0", &ff_qcd_stat_njet2_dm0, &b_ff_qcd_stat_njet2_dm0);
   fChain->SetBranchAddress("ff_qcd_stat_njet2_dm1", &ff_qcd_stat_njet2_dm1, &b_ff_qcd_stat_njet2_dm1);
   fChain->SetBranchAddress("ff_qcd_stat_njet2_dm10", &ff_qcd_stat_njet2_dm10, &b_ff_qcd_stat_njet2_dm10);
   fChain->SetBranchAddress("ff_qcd_stat_njet2_dm11", &ff_qcd_stat_njet2_dm11, &b_ff_qcd_stat_njet2_dm11);
   fChain->SetBranchAddress("pred_class", &pred_class, &b_pred_class);
   fChain->SetBranchAddress("pred_class_proba", &pred_class_proba, &b_pred_class_proba);
   fChain->SetBranchAddress("pred_class_0_proba", &pred_class_0_proba, &b_pred_class_0_proba);
   fChain->SetBranchAddress("pred_class_1_proba", &pred_class_1_proba, &b_pred_class_1_proba);
   fChain->SetBranchAddress("pred_class_2_proba", &pred_class_2_proba, &b_pred_class_2_proba);
   fChain->SetBranchAddress("pred_class_3_proba", &pred_class_3_proba, &b_pred_class_3_proba);
   fChain->SetBranchAddress("pred_class_4_proba", &pred_class_4_proba, &b_pred_class_4_proba);
   Notify();
}
