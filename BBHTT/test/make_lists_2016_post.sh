...
ls $dirMC_UL/DYJetsToLL_M-50/*root > $OUTDIR/DYJetsToLL_M-50
ls $dirMC_UL/DY1JetsToLL_M-50/*root > $OUTDIR/DY1JetsToLL_M-50
ls $dirMC_UL/DY2JetsToLL_M-50/*root > $OUTDIR/DY2JetsToLL_M-50
ls $dirMC_UL/DY3JetsToLL_M-50/*root > $OUTDIR/DY3JetsToLL_M-50
ls $dirMC_UL/DY4JetsToLL_M-50/*root > $OUTDIR/DY4JetsToLL_M-50 
...
ls $dirMC_UL/TTToSemiLeptonic/*root > $OUTDIR/TTToSemiLeptonic
...
ls $dirMC_UL/GluGluHToTauTau_M125/*root > $OUTDIR/GluGluHToTauTau_M125
ls $dirMC_UL/GluGluHToTauTau_amcatnlo_M125_UL16MiniAODv2/*.root > $OUTDIR/GluGluHToTauTau_M125_amcatnlo
