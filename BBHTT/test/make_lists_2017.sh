...
ls $dirMC_UL/DYJetsToLL_M50/*root > $OUTDIR/DYJetsToLL_M-50
ls $dirMC_UL/DYJetsToLL_M50_ext1/*root >> $OUTDIR/DYJetsToLL_M-50
ls $dirMC_UL/DY1JetsToLL_M50/*root > $OUTDIR/DY1JetsToLL_M-50
ls $dirMC_UL/DY2JetsToLL_M50/*root > $OUTDIR/DY2JetsToLL_M-50
ls $dirMC_UL/DY3JetsToLL_M50/*root > $OUTDIR/DY3JetsToLL_M-50
ls $dirMC_UL/DY4JetsToLL_M50/*root > $OUTDIR/DY4JetsToLL_M-50 
