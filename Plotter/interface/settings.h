...
const map<TString, double> xsecs_2016 = {
  ...
  {"DYJetsToLL_M-50_amcatnlo", 6077.2}, // NNLO (20)
...
const map<TString, double> xsecs_2017 = {
  ...
  {"W4JetsToLNu" , 631.5 }, // NNLO (5)
  {"DYJetsToLL_M-50_amcatnlo", 6077.2}, // NNLO (20)
  {"DYJetsToLL_0J_amcatnlo"  , 4840.0}, //
  {"DYJetsToLL_1J_amcatnlo"  , 898.5}, //
  {"DYJetsToLL_2J_amcatnlo"  , 338.7}, //
  {"DYJetsToLL_M-50"       , 6077.22},  // NNLO (20)
...
const map<TString, double> xsecs_2018 = {
  ...
  {"W4JetsToLNu" , 631.5 }, // NNLO (5)      
  {"DYJetsToLL_M-50_amcatnlo", 6077.2}, // NNLO (20)
  {"DYJetsToLL_0J_amcatnlo"  , 4840.0}, // NNLO (20)
  {"DYJetsToLL_1J_amcatnlo"  , 898.5},  // NNLO (20)
  {"DYJetsToLL_2J_amcatnlo"  , 338.7},  // NNLO (20)
  {"DYJetsToLL_M-50"       , 6077.22},  // NNLO (20)
...
std::vector<TString> SingleMuon_2016_pre = {
  "SingleMuon_Run2016B",
  "SingleMuon_Run2016C",
  "SingleMuon_Run2016D",
  "SingleMuon_Run2016E",
...
std::vector<TString> SingleMuon_2016_post = {
  "SingleMuon_Run2016F",
  "SingleMuon_Run2016G",
  "SingleMuon_Run2016H"
};
...
std::vector<TString> DYJets_amcatnlo = {
  "DYJetsToLL_0J_amcatnlo",
  "DYJetsToLL_1J_amcatnlo",
  "DYJetsToLL_2J_amcatnlo"
};

std::vector<TString> DYJets_amcatnlo_incl = {
...
TString SpecificCut(TString era, TString sample) {
  ...
  if (era=="2016_post"&&sample.Contains("Embed"))
    cut = "&&run>=278769";  
  if (sample=="WJetsToLNu"||sample=="DYJetsToLL_M-50")
    cut = "&&gen_noutgoing==0";
